#!/usr/bin/python3
# by Francis Paul: Ftansixpaul@yahoo.com
"""A class that defines a rectanglie based on 8-rectangle.py"""
...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """ A staticmethod that returns the biggest rectangle """
    ...
    def square(cls, size=0):
        """ a class method that returns a new rec...
